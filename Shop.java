...
public class Shop
{
  ...
  private static final int UMBRELLA_COST = 5;
  private static final int ICEE_COST = 10;
  ...
  */
  public void enter(Hunter hunter, String buyOrSell)
  {
    ...
    // }
      ...
      if (cost == 0)
      {
        System.out.println("Uhh.. we don't want that.");
      }
      else
      {
  ...
  */
  public String inventory()
  {
    ...
    str += "Umbrella: " + UMBRELLA_COST +  " gold\n";
    str += "Icee: " + ICEE_COST +  " gold\n";
  ...
  */
  public int getCostOfItem(String item)
  {
    ...
    else if (item.equals("Umbrella") || item.equals("umbrella")){
      return UMBRELLA_COST;
    }
    else if (item.equals("Balloon") || item.equals("balloon")){
      return ICEE_COST;
    }
    else
    {        
